...
checkpoint_path = "/home/hai20521281/Downloads/TEST/checkpoints/model_{epoch:02d}.h5"
...
model_cnn.save('/home/hai20521281/Downloads/TEST/models/model_cnn.h5')
model_lstm.save('/home/hai20521281/Downloads/TEST/models/model_lstm.h5')
model_cnn_lstm.save('/home/hai20521281/Downloads/TEST/models/model_cnn_lstm.h5')
model_cnn_gru.save('/home/hai20521281/Downloads/TEST/models/model_cnn_gru.h5')
...
print(f"CNN Model: Precision: {precision_cnn}, Recall: {recall_cnn}, F1 Score: {f1_cnn}, Accuracy: {accuracy_cnn}")

# Evaluate LSTM
precision_lstm, recall_lstm, f1_lstm, accuracy_lstm = evaluate_model(model_lstm, X_test, to_categorical(y_test, 2))
print(f"LSTM Model: Precision: {precision_lstm}, Recall: {recall_lstm}, F1 Score: {f1_lstm}, Accuracy: {accuracy_lstm}")
...
print(f"CNN + LSTM Model: Precision: {precision_cnn_lstm}, Recall: {recall_cnn_lstm}, F1 Score: {f1_cnn_lstm}, Accuracy: {accuracy_cnn_lstm}")

# Evaluate CNN + GRU
precision_cnn_gru, recall_cnn_gru, f1_cnn_gru, accuracy_cnn_gru = evaluate_model(model_cnn_gru, X_test, to_categorical(y_test, 2))
print(f"CNN + GRU Model: Precision: {precision_cnn_gru}, Recall: {recall_cnn_gru}, F1 Score: {f1_cnn_gru}, Accuracy: {accuracy_cnn_gru}")
