...
csv_file = "labels_improve.csv"
 
def parse(name):
    tmp=name.split("-")[:-1]
    return "_".join(tmp)
 
truee=os.listdir("/home/hai20521281/Downloads/TEST/result_similar_improve")
falsee=os.listdir("/home/hai20521281/Downloads/TEST/result_diff_improve")
