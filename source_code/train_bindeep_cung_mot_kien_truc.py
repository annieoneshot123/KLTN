...
csv_file = "/home/hai20521281/Downloads/bindeep/labels_cung_mot_kien_truc.csv"
dataset_path = "/home/hai20521281/Downloads/bindeep/Cùng một kiến trúc, khác tối ưu hóa và khác trình biên dịch"
folder_names = []
labels = []
...
model = tf.keras.models.Sequential([
    tf.keras.layers.LSTM(20, input_shape=(2, 1024), return_sequences=True),  # LSTM layer
    tf.keras.layers.Conv1D(256, 1, activation='tanh'),  # Convolutional layer
    tf.keras.layers.Conv1D(128, 1, activation='tanh'),  # Convolutional layer
...
# Save the model
model.save('model_bindeep_cung_mot_kien_truc.h5')
